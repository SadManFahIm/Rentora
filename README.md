...
[![Tests](<https://img.shields.io/badge/tests-260%20(133%20BE%20%2B%20127%20FE)-success>)](https://github.com/SadmaFaahiim/Rentora/actions)
...
- **Street search + autocomplete** — type a street, area or station ("gulshan", "mirpur road", "shahbagh") and pick a suggestion to fly there and start a radius search, powered by the curated Dhaka gazetteer (`/rooms/geocode/`)
...
- 260 automated tests (133 backend + 127 frontend) · coverage gates (BE ≥50%, FE ≥55%)
...
| Suite             | Count | Gate                                               |
| ----------------- | ----- | -------------------------------------------------- |
| Backend (Django)  | 133   | ✅ passing · coverage ≥ 50% lines (currently ~61%) |
| Frontend (Vitest) | 127   | ✅ passing · coverage ≥ 55% lines (currently ~99%) |
